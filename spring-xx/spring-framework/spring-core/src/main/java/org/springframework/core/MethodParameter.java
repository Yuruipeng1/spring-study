...
public class MethodParameter {
	...
	//Executable是Method和Constructor的共同父类
	...
	/**
	 * 参数索引小于0，就使用反射method.getReturnType()获取方法返回值类型
	 * 否则使用executable.getParameterTypes()方法得到所有参数类型数组
	 */
	...
	public Annotation[] getParameterAnnotations() {
		...
		if (paramAnns == null) {
			 ...
			 * 该方法参数对应的方法是一个构造器
			 * 并且该方法是一个内部类
			 * 那么在JDK9以下的版本中必须使用实际索引位置减1来访问该参数
			 */
			if (this.executable instanceof Constructor &&
					ClassUtils.isInnerClass(this.executable.getDeclaringClass()) &&
