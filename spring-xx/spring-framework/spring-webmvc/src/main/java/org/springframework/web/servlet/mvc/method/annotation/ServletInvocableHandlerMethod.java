...
public class ServletInvocableHandlerMethod extends InvocableHandlerMethod {
	...
	public void invokeAndHandle(ServletWebRequest webRequest, ModelAndViewContainer mavContainer,
		...
		// 关键 -> 1.执行控制器指定方法,执行处理器方法， 并得到返回值
		Object returnValue = invokeForRequest(webRequest, mavContainer, providedArgs);
		// 2.设置@ResponseStatus注解指定的响应状态码
		...
		if (returnValue == null) {
			/**
			 * 满足下列条件之一的，就不进行后续处理了，直接返回
			 * 1.未修改请求
			 * 2.通过@ResponseStatus注解设置了响应状态码
			 * 3.当前请求已被处理，即ModelAndViewContainer中requestHandled属性为true
			 */
		...
		//有返回值，且通过@ResponseStatus注解指定了响应状态原因
